"""
Script to plot final models for fast convergence
"""
import numpy as np
...
for k,model in enumerate(models):
    ...
    tsteps_invert = np.array([int((times[k]+x)/tstep_interval) for x in [0,1,2,3,4]])
...
fig1.savefig('all_final_fast_ext.pdf')
fig1.savefig('all_final_fast_ext.jpg')
